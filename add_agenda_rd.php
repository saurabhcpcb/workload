...
$insetUserQuery="INSERT INTO tbl_agenda_rd (user_id,name_of_board, subject, division, created) VALUES 
('".$row1['id']."',
 '".addslashes($_POST['name_of_board'])."', 
 ...
 <div class="box box-primary no-print">
			...
			<table  border="1" class="table table-bordered table-striped">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label">Regional Directorate</label>

                  <div class="col-sm-8">
                    <input type="text" class="form-control"  name="name_of_board" value="<?=$row1['board']?>"  id="inputEmail3" tabindex="-1" readonly>
                  </div>
                </div>
			 ...
			 <div class="form-group">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="division" rows="3" id="inputEmail3" >
                  </div>
                </div>
