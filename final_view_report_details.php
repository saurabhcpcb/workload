...
<tr>
<td colspan="5"><h4>Units/Activities(Divisional Head)</h4></td>
</tr>
<tr>
<td width="15%"><strong>Division</strong></td>
<td width="35%"><strong>Units Name</strong></td>
<td width="13%"><strong>Target Date</strong></td>
<td width="17%"><strong>Status</strong></td>
<td width="35%"><strong>Comment</strong></td>
</tr>
...
<td><?php if($activities['final_Status']==0){ echo "Pending";}?> <?php if($activities['final_Status']==1){ echo "Pending";}?> <?php if($activities['final_Status']==2){ echo "Completed";}?> <?php if($activities['Postpone']==1){ echo "/Postpone";}?></td>
