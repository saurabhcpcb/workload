...
<div class="box box-primary">
  ...
  <?php
  $getQuery=mysql_query("SELECT * FROM tbl_user where  id=".$_POST['user_id'].""); 
  $rd=mysql_fetch_array($getQuery);
  ?>
...
$getActivitis=mysql_query("select * from tbl_user_activities_list where user_id=".$_POST['user_id']."");
...
<td colspan="5"> 
<?php
$queryByDate=mysql_query("SELECT * FROM tbl_activities0 where user_id=".$_POST['user_id']." AND YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." GROUP BY main_id ORDER BY main_id DESC");  
...
$activities0=mysql_query("SELECT * FROM  tbl_activities0 where user_id=".$_POST['user_id']." AND main_id=".$dateRow['main_id']."");
...
<table width="100%" border="1" style="margin:6px 0px;">
<?php
$activitiesFile0=mysql_query("SELECT * FROM  tbl_activities0 where user_id=".$_POST['user_id']." AND main_id=".$dateRow['main_id']."");
...
<td colspan="5">
<?php
$queryByDate1=mysql_query("SELECT * FROM tbl_activities1 where user_id=".$_POST['user_id']." AND YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." GROUP BY main_id ORDER BY main_id DESC");  
...
<?php
$i=1;
$activities1=mysql_query("SELECT * FROM  tbl_activities1 where user_id=".$_POST['user_id']." AND main_id=".$dateRow1['main_id']."");
...
<table width="100%" border="1" style="margin:2px 0px;">
<?php
$activitiesFile1=mysql_query("SELECT * FROM  tbl_activities1 where user_id=".$_POST['user_id']." AND main_id=".$dateRow1['main_id']."");
...
<td colspan="5">
<?php
$queryByDate2=mysql_query("SELECT * FROM tbl_activities2 where user_id=".$_POST['user_id']." AND YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." GROUP BY main_id ORDER BY main_id DESC");  
...
<?php
$i=1;
$activities2=mysql_query("SELECT * FROM  tbl_activities2 where user_id=".$_POST['user_id']." AND main_id=".$dateRow2['main_id']."");
...
<table width="100%" border="1" style="margin:2px 0px;">
<?php
$activitiesFile2=mysql_query("SELECT * FROM  tbl_activities2 where user_id=".$_POST['user_id']." AND main_id=".$dateRow2['main_id']."");
...
<td colspan="5"> 
<?php
$queryByDate3=mysql_query("SELECT * FROM tbl_activities3 where user_id=".$_POST['user_id']." AND YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." GROUP BY main_id ORDER BY main_id DESC");  
...
<?php
$i=1;
$activities3=mysql_query("SELECT * FROM  tbl_activities3 where user_id=".$_POST['user_id']." AND  main_id=".$dateRow3['main_id']."");
...
<table width="100%" border="1" style="margin:2px 0px;">
<?php
$activitiesFile3=mysql_query("SELECT * FROM  tbl_activities3 where user_id=".$_POST['user_id']." AND  main_id=".$dateRow3['main_id']."");
...
<td colspan="5"> 
<?php
$queryByDate4=mysql_query("SELECT * FROM tbl_activities4 where user_id=".$_POST['user_id']." AND YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." GROUP BY main_id ORDER BY main_id DESC");  
...
<?php
$i=1;
$activities4=mysql_query("SELECT * FROM  tbl_activities4 where user_id=".$_POST['user_id']." AND main_id=".$dateRow4['main_id']."");
...
<table width="100%" border="1" style="margin:2px 0px;">
<?php
$activitiesFile4=mysql_query("SELECT * FROM  tbl_activities4 where user_id=".$_POST['user_id']." AND main_id=".$dateRow4['main_id']."");
...
<td colspan="5"> 
<?php
$queryByDate5=mysql_query("SELECT * FROM tbl_activities5 where user_id=".$_POST['user_id']." AND YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." GROUP BY main_id ORDER BY main_id DESC");  
...
<?php
$i=1;
$activities5=mysql_query("SELECT * FROM  tbl_activities5 where user_id=".$_POST['user_id']." AND main_id=".$dateRow5['main_id']."");
...
<table width="100%" border="1" style="margin:2px 0px;">
<?php
$activitiesFile5=mysql_query("SELECT * FROM  tbl_activities5 where user_id=".$_POST['user_id']." AND main_id=".$dateRow5['main_id']."");
...
<td colspan="5">
<?php
$queryByDate6=mysql_query("SELECT * FROM tbl_activities6 where user_id=".$_POST['user_id']." AND YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." GROUP BY main_id ORDER BY main_id DESC");  
...
<?php
$i=1;
$activities6=mysql_query("SELECT * FROM  tbl_activities6 where user_id=".$_POST['user_id']." AND main_id=".$dateRow6['main_id']."");
...
<table width="100%" border="1" style="margin:2px 0px;">
<?php
$activitiesFile6=mysql_query("SELECT * FROM  tbl_activities6 where user_id=".$_POST['user_id']." AND main_id=".$dateRow6['main_id']."");
...
<td colspan="5"> 
<?php
$queryByDate7=mysql_query("SELECT * FROM tbl_activities7 where user_id=".$_POST['user_id']." AND YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." GROUP BY main_id ORDER BY main_id DESC");  
...
<?php
$i=1;
$activities7=mysql_query("SELECT * FROM  tbl_activities7 where  user_id=".$_POST['user_id']." AND main_id=".$dateRow7['main_id']."");
...
<table width="100%" border="1" style="margin:2px 0px;">
<?php
$activitiesFile7=mysql_query("SELECT * FROM  tbl_activities7 where user_id=".$_POST['user_id']." AND main_id=".$dateRow7['main_id']."");
...
<td colspan="5"> 
<?php
$queryByDate8=mysql_query("SELECT * FROM tbl_activities8 where user_id=".$_POST['user_id']." AND YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." GROUP BY main_id ORDER BY main_id DESC");  
...
<?php
$i=1;
$activities8=mysql_query("SELECT * FROM  tbl_activities8 where user_id=".$_POST['user_id']." AND main_id=".$dateRow8['main_id']."");
...
<table width="100%" border="1" style="margin:2px 0px;">
<?php
$activitiesFile8=mysql_query("SELECT * FROM  tbl_activities8 where user_id=".$_POST['user_id']." AND main_id=".$dateRow8['main_id']."");
...
<td colspan="5"> 
<?php
$queryByDate9=mysql_query("SELECT * FROM tbl_activities9 where user_id=".$_POST['user_id']." AND YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." GROUP BY main_id ORDER BY main_id DESC");  
...
<?php
$i=1;
$activities9=mysql_query("SELECT * FROM  tbl_activities9 where user_id=".$_POST['user_id']." AND main_id=".$dateRow9['main_id']."");
...
<table width="100%" border="1" style="margin:2px 0px;">
<?php
$activitiesFile9=mysql_query("SELECT * FROM  tbl_activities9 where user_id=".$_POST['user_id']." AND main_id=".$dateRow9['main_id']."");
...
<td colspan="5"> 
<?php
$queryByDate10=mysql_query("SELECT * FROM tbl_activities10 where user_id=".$_POST['user_id']." AND YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." GROUP BY main_id ORDER BY main_id DESC");  
...
<?php
$i=1;
$activities10=mysql_query("SELECT * FROM  tbl_activities10 where user_id=".$_POST['user_id']." AND main_id=".$dateRow10['main_id']."");
...
<table width="100%" border="1" style="margin:2px 0px;">
<?php
$activitiesFile10=mysql_query("SELECT * FROM  tbl_activities10 where user_id=".$_POST['user_id']." AND main_id=".$dateRow10['main_id']."");
...
<td colspan="5"> 
<?php
$queryByDate11=mysql_query("SELECT * FROM tbl_activities11 where user_id=".$_POST['user_id']." AND YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." GROUP BY main_id ORDER BY main_id DESC");  
...
<?php
$i=1;
$activities11=mysql_query("SELECT * FROM  tbl_activities11 where user_id=".$_POST['user_id']." AND main_id=".$dateRow11['main_id']."");
...
<table width="100%" border="1" style="margin:2px 0px;">
<?php
$activitiesFile11=mysql_query("SELECT * FROM  tbl_activities11 where user_id=".$_POST['user_id']." AND main_id=".$dateRow11['main_id']."");
...
<td colspan="5">
<?php
$queryByDate12=mysql_query("SELECT * FROM tbl_activities12 where user_id=".$_POST['user_id']." AND YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." GROUP BY main_id ORDER BY main_id DESC");  
...
<?php
$i=1;
$activities12=mysql_query("SELECT * FROM  tbl_activities12 where user_id=".$_POST['user_id']." AND main_id=".$dateRow12['main_id']."");
...
<table width="100%" border="1" style="margin:2px 0px;">
<?php
$activitiesFile12=mysql_query("SELECT * FROM  tbl_activities12 where user_id=".$_POST['user_id']." AND main_id=".$dateRow12['main_id']."");
...
<td colspan="5"> 
<?php
$queryByDate13=mysql_query("SELECT * FROM tbl_activities13 where user_id=".$_POST['user_id']." AND YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." GROUP BY main_id ORDER BY main_id DESC");  
...
<?php
$i=1;
$activities13=mysql_query("SELECT * FROM  tbl_activities13 where user_id=".$_POST['user_id']." AND main_id=".$dateRow13['main_id']."");
...
<table width="100%" border="1" style="margin:2px 0px;">
<?php
$activitiesFile13=mysql_query("SELECT * FROM  tbl_activities13 where user_id=".$_POST['user_id']." AND main_id=".$dateRow13['main_id']."");
...
<td colspan="5"> 
<?php
$queryByDate14=mysql_query("SELECT * FROM tbl_activities14 where user_id=".$_POST['user_id']." AND YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." GROUP BY main_id ORDER BY main_id DESC");  
...
<?php
$i=1;
$activities14=mysql_query("SELECT * FROM  tbl_activities14 where user_id=".$_POST['user_id']." AND main_id=".$dateRow14['main_id']."");
...
<table width="100%" border="1" style="margin:2px 0px;">
<?php
$activitiesFile14=mysql_query("SELECT * FROM  tbl_activities14 where user_id=".$_POST['user_id']." AND main_id=".$dateRow14['main_id']."");
...
<td colspan="5"> 
<?php
$queryByDate15=mysql_query("SELECT * FROM tbl_activities15 where user_id=".$_POST['user_id']." AND YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." GROUP BY main_id ORDER BY main_id DESC");  
...
<?php
$i=1;
$activities15=mysql_query("SELECT * FROM  tbl_activities15 where user_id=".$_POST['user_id']." AND main_id=".$dateRow15['main_id']."");
...
<table width="100%" border="1" style="margin:2px 0px;">
<?php
$activitiesFile15=mysql_query("SELECT * FROM  tbl_activities15 where user_id=".$_POST['user_id']." AND main_id=".$dateRow15['main_id']."");
...
<td colspan="5"> 
<?php
$queryByDate16=mysql_query("SELECT * FROM tbl_activities16 where user_id=".$_POST['user_id']." AND YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." GROUP BY main_id ORDER BY main_id DESC");  
...
<?php
$i=1;
$activities16=mysql_query("SELECT * FROM  tbl_activities16 where user_id=".$_POST['user_id']." AND main_id=".$dateRow16['main_id']."");
...
<table width="100%" border="1" style="margin:2px 0px;">
<?php
$activitiesFile16=mysql_query("SELECT * FROM  tbl_activities16 where user_id=".$_POST['user_id']." AND main_id=".$dateRow16['main_id']."");
...
<td colspan="5"> 
<?php
$queryByDate17=mysql_query("SELECT * FROM tbl_activities17 where user_id=".$_POST['user_id']." AND YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." GROUP BY main_id ORDER BY main_id DESC");  
...
<?php
$i=1;
$activities17=mysql_query("SELECT * FROM  tbl_activities17 where user_id=".$_POST['user_id']." AND main_id=".$dateRow17['main_id']."");
...
<table width="100%" border="1" style="margin:2px 0px;">
<?php
$activitiesFile17=mysql_query("SELECT * FROM  tbl_activities17 where user_id=".$_POST['user_id']." AND main_id=".$dateRow17['main_id']."");
