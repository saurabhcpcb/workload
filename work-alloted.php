...
<tr>
<td width="11%" style="background:#eeeff0;"><strong>Division</strong></td>
<td width="23%" style="background:#eeeff0;"><strong>Units Name</strong></td>
<td width="11%" style="background:#eeeff0;"><strong>Target Date</strong></td>
<td width="11%" style="background:#eeeff0;"><strong>Status</strong></td>
<td width="15%" style="background:#eeeff0;"><strong>Assigned on</strong></td>
<td width="44%" style="background:#eeeff0;"><strong>Comment</strong></td>
</tr>


 
<?php
$proposedQuery0=mysqli_query($mysqli, " select * from tbl_activities0 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1  GROUP BY  activities_name");
...
$proposedQuery0=mysqli_query($mysqli, " select * from tbl_activities0 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND activities_name='".$proposed0['activities_name']."' AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1");
...
<td valign="top"><?php if($activities0['final_Status']==1){ echo "Alloted";}?><?php if($activities0['Postpone']==1){ ?>/Postpone<?php }?></td>
...
<?php
$proposedQuery1=mysqli_query($mysqli, " select * from tbl_activities1 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1  GROUP BY  activities_name");
...
<?php
$proposedQuery1=mysqli_query($mysqli, " select * from tbl_activities1 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND activities_name='".$proposed1['activities_name']."' AND final_Status =1");
...
<td valign="top"><?php if($activities1['final_Status']==1){ echo "Alloted";}?><?php if($activities1['Postpone']==1){ ?>/Postpone <?php }?></td>
...
<?php
$proposedQuery2=mysqli_query($mysqli, " select * from tbl_activities2 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1  GROUP BY  activities_name");
...
<?php
$proposedQuery2=mysqli_query($mysqli, " select * from tbl_activities2 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND activities_name='".$proposed2['activities_name']."' AND final_Status =1");
...
<td valign="top"><?php if($activities2['final_Status']==1){ echo "Alloted";}?><?php if($activities2['Postpone']==1){ ?>/Postpone <?php }?></td>
...
<?php
$proposedQuery3=mysqli_query($mysqli, " select * from tbl_activities3 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1  GROUP BY  activities_name");
...
<?php
$proposedQuery3=mysqli_query($mysqli, " select * from tbl_activities3 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND activities_name='".$proposed3['activities_name']."' AND final_Status =1");
...
<td valign="top"><?php if($activities3['final_Status']==1){ echo "Alloted";}?><?php if($activities3['Postpone']==1){ ?>/Postpone <?php }?></td>
...
<?php
$proposedQuery4=mysqli_query($mysqli, " select * from tbl_activities4 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1  GROUP BY  activities_name");
...
<?php
$proposedQuery4=mysqli_query($mysqli, " select * from tbl_activities4 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND activities_name='".$proposed4['activities_name']."' AND final_Status =1");
...
<td valign="top"><?php if($activities4['final_Status']==1){ echo "Alloted";}?><?php if($activities4['Postpone']==1){ ?>/Postpone <?php }?></td>
...
<?php
$proposedQuery5=mysqli_query($mysqli, " select * from tbl_activities5 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1  GROUP BY  activities_name");
...
<?php
$proposedQuery5=mysqli_query($mysqli, " select * from tbl_activities5 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND activities_name='".$proposed5['activities_name']."' AND final_Status =1");
...
<td valign="top"><?php if($activities5['final_Status']==1){ echo "Alloted";}?><?php if($activities5['Postpone']==1){ ?>/Postpone <?php }?></td>
...
<?php
$proposedQuery6=mysqli_query($mysqli, " select * from tbl_activities6 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1  GROUP BY  activities_name");
...
<?php
$proposedQuery6=mysqli_query($mysqli, " select * from tbl_activities6 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND activities_name='".$proposed6['activities_name']."' AND final_Status =1");
...
<td valign="top"><?php if($activities6['final_Status']==1){ echo "Alloted";}?><?php if($activities6['Postpone']==1){ ?>/Postpone <?php }?></td>
...
<?php
$proposedQuery7=mysqli_query($mysqli, " select * from tbl_activities7 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1  GROUP BY  activities_name");
...
<?php
$proposedQuery7=mysqli_query($mysqli, " select * from tbl_activities7 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND activities_name='".$proposed7['activities_name']."' AND final_Status =1");
...
<td valign="top"><?php if($activities7['final_Status']==1){ echo "Alloted";}?><?php if($activities7['Postpone']==1){ ?>/Postpone <?php }?></td>
...
<?php
$proposedQuery8=mysqli_query($mysqli, " select * from tbl_activities8 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1  GROUP BY  activities_name");
...
<?php
$proposedQuery8=mysqli_query($mysqli, " select * from tbl_activities8 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND activities_name='".$proposed8['activities_name']."' AND final_Status =1");
...
<td valign="top"><?php if($activities8['final_Status']==1){ echo "Alloted";}?><?php if($activities8['Postpone']==1){ ?>/Postpone <?php }?></td>
...
<?php
$proposedQuery9=mysqli_query($mysqli, " select * from tbl_activities9 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1  GROUP BY  activities_name");
...
$proposedQuery9=mysqli_query($mysqli, " select * from tbl_activities9 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."'  AND activities_name='".$proposed9['activities_name']."' AND final_Status =1");
...
<td valign="top"><?php if($activities9['final_Status']==1){ echo "Alloted";}?><?php if($activities9['Postpone']==1){ ?>/Postpone <?php }?></td>
...
<?php
$proposedQuery10=mysqli_query($mysqli, " select * from tbl_activities10 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1  GROUP BY  activities_name");
while ($proposed10=mysqli_fetch_array($proposedQuery10,mysqli_ASSOC)){
?>

<tr><td colspan="6"><h4 style="color:#1d0cc6;"><i class="fa fa-fw fa-hand-o-right"></i><?=$proposed10['activities_name']?> </h4></td></tr> 

<?php
$proposedQuery10=mysqli_query($mysqli, " select * from tbl_activities10 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND activities_name='".$proposed10['activities_name']."' AND final_Status =1");
...
<?php
$proposedQuery11=mysqli_query($mysqli, " select * from tbl_activities11 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1  GROUP BY  activities_name");
...
<?php
$proposedQuery11=mysqli_query($mysqli, " select * from tbl_activities11 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND activities_name='".$proposed11['activities_name']."' AND final_Status =1");
...
<td valign="top"><?php if($activities11['final_Status']==1){ echo "Alloted";}?><?php if($activities11['Postpone']==1){ ?>/Postpone <?php }?></td>
...
<?php
$proposedQuery12=mysqli_query($mysqli, " select * from tbl_activities12 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1  GROUP BY  activities_name");
...
<?php
$proposedQuery12=mysqli_query($mysqli, " select * from tbl_activities12 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."'  AND activities_name='".$proposed12['activities_name']."' AND final_Status =1");
...
<td valign="top"><?php if($activities12['final_Status']==1){ echo "Alloted";}?><?php if($activities12['Postpone']==1){ ?>/Postpone <?php }?></td>
...
<?php
$proposedQuery13=mysqli_query($mysqli, " select * from tbl_activities13 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1  GROUP BY  activities_name");
...
<?php
$proposedQuery13=mysqli_query($mysqli, " select * from tbl_activities13 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND activities_name='".$proposed13['activities_name']."' AND final_Status =1");
...
<td valign="top"><?php if($activities13['final_Status']==1){ echo "Alloted";}?><?php if($activities13['Postpone']==1){ ?>/Postpone <?php }?></td>
...
<?php
$proposedQuery14=mysqli_query($mysqli, " select * from tbl_activities14 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1  GROUP BY  activities_name");
...
<?php
$proposedQuery14=mysqli_query($mysqli, " select * from tbl_activities14 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND activities_name='".$proposed14['activities_name']."' AND final_Status =1");
...
<td valign="top"><?php if($activities14['final_Status']==1){ echo "Alloted";}?><?php if($activities14['Postpone']==1){ ?>/Postpone <?php }?></td>
...
<?php
$proposedQuery15=mysqli_query($mysqli, " select * from tbl_activities15 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1  GROUP BY  activities_name");
...
<?php
$proposedQuery15=mysqli_query($mysqli, " select * from tbl_activities15 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND activities_name='".$proposed15['activities_name']."'  AND final_Status =1");
...
<td valign="top"><?php if($activities15['final_Status']==1){ echo "Alloted";}?><?php if($activities15['Postpone']==1){ ?>/Postpone <?php }?></td>
...
<?php
$proposedQuery16=mysqli_query($mysqli, " select * from tbl_activities16 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1  GROUP BY  activities_name");
...
<?php
$proposedQuery16=mysqli_query($mysqli, " select * from tbl_activities16 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND 
priority='".$_GET['activities']."' AND activities_name='".$proposed16['activities_name']."' AND final_Status =1");
...
<td valign="top"><?php if($activities16['final_Status']==1){ echo "Alloted";}?><?php if($activities16['Postpone']==1){ ?>/Postpone <?php }?></td>
...
<?php
$proposedQuery17=mysqli_query($mysqli, " select * from tbl_activities17 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND final_Status =1  GROUP BY  activities_name");
...
$proposedQuery17=mysqli_query($mysqli, " select * from tbl_activities17 where  YEAR(Proposed_on) = ".$year." AND MONTH(Proposed_on) = ".$month." AND  rd_id='".$_GET['rd']."' AND priority='".$_GET['activities']."' AND activities_name='".$proposed17['activities_name']."' AND final_Status =1");
...
<td valign="top"><?php if($activities17['final_Status']==1){ echo "Alloted";}?><?php if($activities17['Postpone']==1){ ?>/Postpone <?php }?></td>
