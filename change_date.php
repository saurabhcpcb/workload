...
$getData=mysqli_query($mysqli, " SELECT * FROM $dhTable where target_date='".date("Y-m-d", strtotime($_GET['cid']))."' AND rd_id='".$_GET['rd']."'");
...
if(isset($_POST['submit']) && $_POST['submit']=="Save"){
 ...
 $updateQuery=mysqli_query($mysqli, " UPDATE $dhTable SET target_date='".date("Y-m-d", strtotime($_POST['taget']))."' WHERE main_id=".$_POST['id']." AND rd_id='".$_POST['rd']."'");
...
<input name="id" value="<?=$getQueryResult['main_id']?>" type="hidden">
<input name="rd" value="<?=$getQueryResult['rd_id']?>" type="hidden">
<tr>
<td> 
                
            
                 
                  <input type="text" value="<?=$_GET['cid']?>"  name="taget" class="form-control" id="datepicker">
...
<tr>
<td><input name="submit" value="Save" class="btn bg-orange" type="submit"></td>
</tr>
</form>
