...
$extension = end($temp);
$fileName=time()."".rand()."1".".".$extension;
}
else
{
$fileName="";
...
<input name="activities" type="hidden" value="<?=urldecode($_GET['unit'])?>">

<tr>

<td valign="top" align="left"><textarea name="Unit_Name" cols="" rows="" class="form-control"><?=$_POST['Unit_Name']?></textarea></td>
</tr>
<tr>
...
<option value="P1" <?=($_POST['priority']=="P1")?'selected':''?> >P1</option>
<option value="P2" <?=($_POST['priority']=="P2")?'selected':''?>>P2</option>
<option value="P3" <?=($_POST['priority']=="P3")?'selected':''?>>P3</option>
<option value="P4" <?=($_POST['priority']=="P4")?'selected':''?>>P4</option>
</select></td>
</tr>
<tr>          

<td valign="top" align="left"><input name="target_date" type="text" value="<?=$_POST['target_date']?>" style="width:40%; float:left;" class="form-control"  id="datepicker1"></td>           
</tr>

<tr>          

<td valign="top" align="left"><input name="upload_file" type="file"></td>           
</tr>
<tr>
