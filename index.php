...
if (isset($_POST['process']) == "loginDetails" && isset($_POST['process']) != "") {
	...
	$query = mysqli_query($mysqli, "SELECT * FROM tbl_user WHERE BINARY username = '" . $username . "'  AND BINARY password = '" . $password . "'");
				...
				<div class="login-form">
					<form action="" method="post">
						...
						<div class="w3ls-icon">
							...
							<input type="text" class="user" name="username" value="<?= $_POST['username'] ?>"
								placeholder="User Name" required="" />
						</div>
						<div class="w3ls-icon">

							<input type="password" class="lock" name="password" value="<?= $_POST['password'] ?>"
								placeholder="Password" required="" />
						</div>
						<div class="signin-rit">
							<span class="checkbox1">
								<label class="checkbox"><input type="checkbox" name="checkbox" checked="">Remember
									me</label>
							</span>
