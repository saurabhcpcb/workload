...
?>
          ...
          <div class="box box-primary">
            ...
            <input name="process" type="hidden" value="editData">
            <input name="editId" type="hidden" value="<?=$user['id']?>">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control"  name="password" data-toggle="password" data-placement="before" value="<?=$user['password']?>">
                   
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">User Type</label>
                   <select name="user_type" class="form-control" onChange="usertypeInformation(this.value)">
                    <option value="Admin" <?=($user['user_type']=="Admin")?'selected':''?> >Admin</option>
                    <option  value="MS" <?=($user['user_type']=="MS")?'selected':''?>>MS</option>
                   <option  value="CPCB" <?=($user['user_type']=="CPCB")?'selected':''?>>CPCB</option>
                    <option  value="SPCB" <?=($user['user_type']=="SPCB")?'selected':''?>>SPCB</option>
				...
				<div class="form-group">
                  <label for="exampleInputEmail1">Division</label>
                   <select name="division" class="form-control" onChange="usertypeInformation(this.value)">
				   <?php 
				...
				?>
                  ...
                  <input type="text" class="form-control"  name="Officer"   value="<?=$user['Officer']?>">
                </div>
                
                <div class="form-group">
                  <label for="exampleInputEmail1">Email Id</label>
                  <input type="text" class="form-control"  name="emailid"  value="<?=$user['emailid']?>">
                </div>
                ...
                <input name="activities[]" id="langOpt12" type="checkbox"  <?php if (in_array($activities['id'], $dataList)) { echo "checked";}?>   value="<?=$activities['id']?>" <?php if(in_array($activities['id'],$_POST['activities'])){ echo"checked";} ?> />&nbsp;<?=$i?><i class="fa fa-fw fa-long-arrow-right"></i><?=$activities['Activities']?> </div>
