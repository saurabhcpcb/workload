...
<table width="100%" border="1">
  <tr>
    <td width="30%"> <input name="fromDate"  value="<?=$_POST['fromDate']?>" class="form-control" id="datepicker-example11" type="text"></td>
    <td width="38%"><input name="toDate"  value="<?=$_POST['toDate']?>" class="form-control" id="datepicker-example13" type="text"></td>
    <td width="32%"> <input name="submit" type="submit"  class="btn bg-olive margin" value="Submit"></td>
  </tr>
</table>
</form>
...
<div class="box box-primary">
  ...
  <h4 align="center">Date : <?=date("d-M-Y", strtotime($_POST['fromDate']))?>&nbsp;To&nbsp;<?=date("d-M-Y", strtotime($_POST['toDate']))?> </h4>
...
?>
  ...
  <tr>
    ...
    Target Date :  <span style="color:#237a1a; font-size:14px; font-weight:600;" ><?=date("d-M-Y", strtotime($activitiesList0['target_date']))?></span>&nbsp;&nbsp;&nbsp; <?php if(!empty($activitiesList0['target_date_before'])  && $activitiesList0['target_date']!=$activitiesList0['target_date_before']){?> <span style="color:#FF0000; font-size:14px; font-weight:600; text-decoration:line-through;" ><?=date("d-M-Y", strtotime($activitiesList0['target_date_before']))?></span><?php } ?>
...
?>
  ...
  <tr>
    ...
    Target Date : <span style="color:#237a1a; font-size:14px; font-weight:600;" ><?=date("d-M-Y", strtotime($activitiesList1['target_date']))?></span>&nbsp;&nbsp;&nbsp; <?php if(!empty($activitiesList1['target_date_before']) && $activitiesList1['target_date']!=$activitiesList1['target_date_before']){?> <span style="color:#FF0000; font-size:14px; font-weight:600; text-decoration:line-through;" ><?=date("d-M-Y", strtotime($activitiesList1['target_date_before']))?></span><?php } ?>
...
?>
  ...
  <tr>
    ...
    Target Date : <span style="color:#237a1a; font-size:14px; font-weight:600;" ><?=date("d-M-Y", strtotime($activitiesList2['target_date']))?></span>&nbsp;&nbsp;&nbsp; <?php if(!empty($activitiesList2['target_date_before']) && $activitiesList2['target_date']!=$activitiesList2['target_date_before']){?> <span style="color:#FF0000; font-size:14px; font-weight:600; text-decoration:line-through;" ><?=date("d-M-Y", strtotime($activitiesList2['target_date_before']))?></span><?php } ?>
...
?>
  ...
  <tr>
    ...
    Target Date : <span style="color:#237a1a; font-size:14px; font-weight:600;" ><?=date("d-M-Y", strtotime($activitiesList5['target_date']))?></span>&nbsp;&nbsp;&nbsp; <?php if(!empty($activitiesList5['target_date_before']) && $activitiesList5['target_date']!=$activitiesList5['target_date_before']){?> <span style="color:#FF0000; font-size:14px; font-weight:600; text-decoration:line-through;" ><?=date("d-M-Y", strtotime($activitiesList5['target_date_before']))?></span><?php } ?>
...
?>
  ...
  <tr>
    ...
    Target Date : <span style="color:#237a1a; font-size:14px; font-weight:600;" ><?=date("d-M-Y", strtotime($activitiesList6['target_date']))?></span>&nbsp;&nbsp;&nbsp; <?php if(!empty($activitiesList6['target_date_before']) && $activitiesList6['target_date']!=$activitiesList6['target_date_before']){?> <span style="color:#FF0000; font-size:14px; font-weight:600; text-decoration:line-through;" ><?=date("d-M-Y", strtotime($activitiesList6['target_date_before']))?></span><?php } ?>
    </td>
...
?>
  ...
  <tr>
    ...
    Target Date : <span style="color:#237a1a; font-size:14px; font-weight:600;" ><?=date("d-M-Y", strtotime($activitiesList7['target_date']))?></span>&nbsp;&nbsp;&nbsp; <?php if(!empty($activitiesList7['target_date_before']) && $activitiesList7['target_date']!=$activitiesList7['target_date_before']){?> <span style="color:#FF0000; font-size:14px; font-weight:600; text-decoration:line-through;" ><?=date("d-M-Y", strtotime($activitiesList7['target_date_before']))?></span><?php } ?>
    </td>
...
?>
  ...
  <tr>
    ...
    Target Date : <span style="color:#237a1a; font-size:14px; font-weight:600;" ><?=date("d-M-Y", strtotime($activitiesList11['target_date']))?></span>&nbsp;&nbsp;&nbsp; <?php if(!empty($activitiesList11['target_date_before']) && $activitiesList11['target_date']!=$activitiesList11['target_date_before']){?> <span style="color:#FF0000; font-size:14px; font-weight:600; text-decoration:line-through;" ><?=date("d-M-Y", strtotime($activitiesList11['target_date_before']))?></span><?php } ?></td>
...
?>
  ...
  <tr>
    ...
    <i class="fa fa-fw fa-long-arrow-right"></i>Completed</span></span><?php } if($activitiesList12['final_Status']==1) {?><span style="color:#FF0000; float:right; text-align:right;"><i class="fa fa-fw fa-long-arrow-right"></i>Pending at RD</span> <?php }  if($activitiesList12['final_Status']==0) {?><span style="color:#FF0000; float:right; text-align:right;"><i class="fa fa-fw fa-long-arrow-right"></i>Pending at MS</span> <?php }?>
      ...
      <br>
    Target Date : <span style="color:#237a1a; font-size:14px; font-weight:600;" ><?=date("d-M-Y", strtotime($activitiesList12['target_date']))?></span>&nbsp;&nbsp;&nbsp; <?php if(!empty($activitiesList12['target_date_before']) && $activitiesList13['target_date']!=$activitiesList13['target_date_before']){?> <span style="color:#FF0000; font-size:14px; font-weight:600; text-decoration:line-through;" ><?=date("d-M-Y", strtotime($activitiesList12['target_date_before']))?></span><?php } ?>
    </td>
...
?>
  ...
  <tr>
    ...
    Target Date : <span style="color:#237a1a; font-size:14px; font-weight:600;" ><?=date("d-M-Y", strtotime($activitiesList13['target_date']))?></span>&nbsp;&nbsp;&nbsp; <?php if(!empty($activitiesList13['target_date_before']) && $activitiesList14['target_date']!=$activitiesList14['target_date_before']){?> <span style="color:#FF0000; font-size:14px; font-weight:600; text-decoration:line-through;" ><?=date("d-M-Y", strtotime($activitiesList13['target_date_before']))?></span><?php } ?>
    </td>
...
?>
  ...
  <tr>
    ...
    <i class="fa fa-fw fa-long-arrow-right"></i>Completed</span></span><?php } if($activitiesList14['final_Status']==1) {?><span style="color:#FF0000; float:right; text-align:right;"><i class="fa fa-fw fa-long-arrow-right"></i>Pending at RD</span> <?php }  if($activitiesList14['final_Status']==0) {?><span style="color:#FF0000; float:right; text-align:right;"><i class="fa fa-fw fa-long-arrow-right"></i>Pending at MS</span> <?php }?>
     ...
     <br>
    Target Date : <span style="color:#237a1a; font-size:14px; font-weight:600;" ><?=date("d-M-Y", strtotime($activitiesList14['target_date']))?></span>&nbsp;&nbsp;&nbsp; <?php if(!empty($activitiesList14['target_date_before']) && $activitiesList15['target_date']!=$activitiesList15['target_date_before']){?> <span style="color:#FF0000; font-size:14px; font-weight:600; text-decoration:line-through;" ><?=date("d-M-Y", strtotime($activitiesList14['target_date_before']))?></span><?php } ?>
...
?>
  ...
  <tr>
    ...
    <i class="fa fa-fw fa-long-arrow-right"></i>Completed</span></span><?php } if($activitiesList16['final_Status']==1) {?><span style="color:#FF0000; float:right; text-align:right;"><i class="fa fa-fw fa-long-arrow-right"></i>Pending at RD</span> <?php }  if($activitiesList16['final_Status']==0) {?><span style="color:#FF0000; float:right; text-align:right;"><i class="fa fa-fw fa-long-arrow-right"></i>Pending at MS</span> <?php }?>
     ...
     <br>
    Target Date: <span style="color:#237a1a; font-size:14px; font-weight:600;" ><?=date("d-M-Y", strtotime($activitiesList16['target_date']))?></span>&nbsp;&nbsp;&nbsp; <?php if(!empty($activitiesList16['target_date_before']) && $activitiesList16['target_date']!=$activitiesList16['target_date_before']){?> <span style="color:#FF0000; font-size:14px; font-weight:600; text-decoration:line-through;" ><?=date("d-M-Y", strtotime($activitiesList16['target_date_before']))?></span><?php } ?> 
    </td>
...
?>
  ...
  <tr>
    ...
    Target Date <span style="color:#237a1a; font-size:14px; font-weight:600;" ><?=date("d-M-Y", strtotime($activitiesList17['target_date']))?></span>&nbsp;&nbsp;&nbsp; <?php if(!empty($activitiesList17['target_date_before']) && $activitiesList17['target_date']!=$activitiesList17['target_date_before']){?> <span style="color:#FF0000; font-size:14px; font-weight:600; text-decoration:line-through;" ><?=date("d-M-Y", strtotime($activitiesList17['target_date_before']))?></span><?php } ?>
